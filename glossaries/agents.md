...
From one call to a whole session.
...
What the transcript holds and a call sends.
...
What the model may request, and what contains it.
...
Caps, and what is cut to fit them.
...
An agent is named by its workspace.
