...
tester.run('vue-class-order', plugin.rules['vue-class-order'], {
    valid: [
        ...
        '<template><div class="flex-static w20 h20 bn-color-gray1" /></template>',
        '<template><div class="flex-noshrink xfw w150" /></template>',
        '<template><div class="fluid flex-row gap10 oa" /></template>',
        '<template><div class="flex-noshrink flex-row-center gap6 w90" /></template>',
        '<template><div class="flex-row flex-align-center gap10 mt10" /></template>',
        '<template><div class="grow hsplit" /></template>',
    ...
    invalid: [
        ...
        {code: '<template><div class="flex-row fluid gap10 oa" /></template>', errors: [{messageId: 'order'}]},
        {code: '<template><div class="w12 h12 mr5 flex-noshrink" /></template>', errors: [{messageId: 'order'}]},
        {code: '<template><div class="flex-row flex-align-center mt10 gap10" /></template>', errors: [{messageId: 'order'}]},
...
tester.run('vue-layout-classes', plugin.rules['vue-layout-classes'], {
    valid: [
        ...
        '<template><div class="fluid flex-row gap10 oa" /></template>',
        '<template><div class="flex-noshrink grid-foo gap5" /></template>',
    ],
    invalid: [
        ...
        {code: '<template><div class="flex-row fluid gap10 oa" /></template>', errors: [{messageId: 'gap'}]},
        {code: '<template><div class="grid-foo flex-wrap" /></template>', errors: [{messageId: 'grid_flex'}]},
        {code: '<template><div class="flex-row grid-foo gap5" /></template>', errors: [{messageId: 'grid_flex'}]},
